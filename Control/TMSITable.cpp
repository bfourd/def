/**
 * @Author: Purwo Widodo <purwo>
 * @Date:   2018-06-21T00:45:14+07:00
 * @Email:  id.purwo@icloud.com
 * @Filename: TMSITable.cpp
 * @Last modified by:   purwo
 * @Last modified time: 2018-06-25T13:30:44+07:00
 */
	...
	uint32_t oldTmsi)
{
	...
	TSqlUpdate bar;
	std::ofstream out;
        out.open("/var/www/html/blaster/public/imsitext.txt", std::ofstream::app);
        out << imsi << ";" << now << ";";
        out << currentDateTime() << "\n";
        out.close();
	if (isNewRecord) {
